...
export default function SkillProfileGraph() {
  ...
  return (
    <div className="h-full flex font-body-md bg-surface text-on-surface">
      ...
      <li>
      <Link className="flex items-center gap-md px-md py-sm rounded text-primary font-bold border-l-4 border-primary bg-surface-container-high transition-all scale-95 active:scale-90 font-label-md text-label-md" to="/skill-assessment">
